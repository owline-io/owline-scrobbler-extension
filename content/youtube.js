/**
 * YouTube / YouTube Music scrobbler.
 *
 * Reads the video title and channel name from the page.
 * For YouTube Music, reads from the player bar.
 */
...
function getTrackInfo() {
  ...
  // Skip non-music (> 20min likely podcast/stream)
